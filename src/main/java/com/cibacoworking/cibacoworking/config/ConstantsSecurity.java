...
public class ConstantsSecurity {
    ...
    //User reservations
    public static final String GET_RESERVATIONS_BY_USER = "/api/resevations/user/{userId}";
    public static final String CREATE_RESERVATION_BY_USER = "/api/resevations/user/create";

    //Admin reservations
    public static final String CREATE_RESERVATION_ADMIN = "/api/resevations/admin/create";
